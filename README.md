...
1. `600.perlbench_s-210B` (General integer benchmark)
2. `bc.web-704B` (Web graph search)
3. `bfs.road-140B` (Irregular graph traversal)
4. `xs.XL100nuclide-296B` (Monte Carlo neutron transport)
...
1. **Optimal Genome Configuration (Config 2 - Pareto Winner):**
...
2. **Why Config 2 (L2-Only) is the Architectural Sweet Spot:**
...
3. **Gated Prefetching Prevents Cache Pollution:**
...
* **Config 1 (L1-Only):**
  * Baseline Summary: [`config1-l1only-baseline-summary.md`](./config1-l1only-baseline-summary.md)
  * Agent 10-Gen Summary: [`config1-agent-10gen-summary.md`](./config1-agent-10gen-summary.md)
  * Search Trajectory JSON: [`chia-search-history-10gen.json`](./chia-search-history-10gen.json)

* **Config 2 (L2-Only):**
  * Baseline Summary: [`config2-l2only-baseline-summary.md`](./config2-l2only-baseline-summary.md)
  * Agent 10-Gen Summary: [`config2-agent-10gen-summary.md`](./config2-agent-10gen-summary.md)
  * Search Trajectory JSON: [`chia-search-history-config2-10gen.json`](./chia-search-history-config2-10gen.json)

* **Config 3 (Joint L1 + L2 Hierarchy):**
  * Baseline Summary: [`config3-l1l2hierarchy-baseline-summary.md`](./config3-l1l2hierarchy-baseline-summary.md)
  * Agent 10-Gen Summary: [`config3-agent-10gen-summary.md`](./config3-agent-10gen-summary.md)
  * Search Trajectory JSON: [`chia-search-history-config3-10gen.json`](./chia-search-history-config3-10gen.json)
...
1. Go to **[github.com/pranavdur/CHIA-Prefetcher-Agent/edit/main/README.md](https://github.com/pranavdur/CHIA-Prefetcher-Agent/edit/main/README.md)**.
2. Select all text, delete it, and paste this block.
3. Click **Commit changes...** at the top right to publish.
